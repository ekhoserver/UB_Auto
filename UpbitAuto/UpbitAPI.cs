...
namespace UpbitAuto
{
    class UpbitAPI
    {
        ...
        public string MakeOrder(string market, UpbitOrderSide side, string volume, string price, UpbitOrderType ord_type = UpbitOrderType.limit)
        {
            string url = "https://api.upbit.com/v1/orders";
            return CallAPI_WithParam(url, new NameValueCollection { { "market", market }, { "side", side.ToString() }, { "volume", volume }, { "price", price.ToString() }, { "ord_type", ord_type.ToString() } }, HttpMethod.Post);
        }


        public string MakeOrder(string market, UpbitOrderSide side, decimal volume, string price, UpbitOrderType ord_type = UpbitOrderType.limit)
        {
            string url = "https://api.upbit.com/v1/orders";
        ...
        public string MakeOrder(string market, UpbitOrderSide side, decimal volume, UpbitOrderType ord_type = UpbitOrderType.limit)
        {
            string url = "https://api.upbit.com/v1/orders";
            return CallAPI_WithParam(url, new NameValueCollection { { "market", market }, { "side", side.ToString() }, { "volume", volume.ToString() }, { "ord_type", ord_type.ToString() } }, HttpMethod.Post);
        }
